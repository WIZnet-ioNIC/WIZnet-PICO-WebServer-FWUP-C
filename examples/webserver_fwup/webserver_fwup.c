...
static uint8_t g_http_socket_num_list[HTTP_SOCKET_MAX_NUM] = {0, 1, 2, 3, 4};
...
int main()
{
    ...
    printf("WebServer Domain : http://%d.%d.%d.%d:%d\r\n", g_net_info.ip[0], g_net_info.ip[1], g_net_info.ip[2], g_net_info.ip[3], HTTP_SERVER_PORT);
